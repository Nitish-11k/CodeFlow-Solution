...
export default function BlogList() {
  ...
  return (
    ...
    <main className="bg-[#020617] min-h-screen flex flex-col">
      ...
      <section className="pt-32 pb-12 px-6 text-center bg-[#020617] text-white relative overflow-hidden">
      ...
      <div className="sticky top-20 z-40 bg-[#020617]/90 backdrop-blur-md border-b border-white/5 py-4">
            ...
            {CATEGORIES.map((cat) => (
                <button
                    ...
                    ${activeCategory === cat 
                        ...
                        : "bg-white/5 text-gray-400 border-white/10 hover:border-[#D4AF37] hover:text-[#D4AF37]"
                    }`}
                >
                    {cat}
                </button>
        ...
        {totalPages > 1 && (
            <div className="flex justify-center items-center gap-4 mt-16">
                <button 
                    ...
                    className="p-3 rounded-full border border-white/10 text-gray-400 hover:bg-[#D4AF37] hover:text-[#020617] hover:border-[#D4AF37] disabled:opacity-30 disabled:hover:bg-transparent disabled:hover:text-gray-400 transition-all"
                >
                    <ChevronLeft size={20} />
                </button>
