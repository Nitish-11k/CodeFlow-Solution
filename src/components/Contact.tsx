        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-12">
            <div>
              ...
              <h2 className="text-4xl md:text-5xl font-black text-[var(--text-primary)] mb-6 leading-tight">
                Ready to launch <br/>
                <span className="text-[#D4AF37]">your dream?</span>
              </h2>
              
              <div className="space-y-4 text-[var(--text-secondary)] text-lg leading-relaxed max-w-md">
            ...
            {/* Email Contact */}
            <div className="flex items-center gap-4 text-[var(--text-primary)]/80">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-[var(--text-primary)]">solutioncodeflow@gmail.com</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--card-bg)]/50 border border-white/10 p-8 md:p-10 rounded-[2.5rem] shadow-2xl shadow-black/50 relative min-h-[500px] flex flex-col justify-center backdrop-blur-sm">
            ...
            <AnimatePresence mode="wait">
              {success ? (
                 ...
                 >
                    ...
                    <h3 className="text-3xl font-bold text-[var(--text-primary)] mb-2">Message Sent!</h3>
                    <p className="text-[var(--text-secondary)] text-lg">We will reply shortly.</p>
                 </motion.div>
              ) : (
                <motion.div 
                   key="form"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="grid md:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-[var(--text-secondary)] ml-1">Name</label>
                        <input 
                          type="text" name="name" required value={formData.name} onChange={handleChange}
                          placeholder="John Doe"
                          className="w-full p-4 rounded-xl bg-[var(--background)] border border-white/10 text-[var(--text-primary)] focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all" 
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-sm font-semibold text-[var(--text-secondary)] ml-1">Email</label>
                        <input 
                    ...
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-[var(--text-secondary)] ml-1">Requirement</label>
                      <textarea 
                        name="requirement" required value={formData.requirement} onChange={handleChange}
                        placeholder="Tell us about your project..."
                        className="w-full p-4 rounded-xl bg-[var(--background)] border border-white/10 text-[var(--text-primary)] focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all min-h-[160px] resize-none" 
                      />
                    </div>

                    <button 
                      type="submit" disabled={loading}
                      className="w-full py-4 bg-[#D4AF37] text-[var(--background)] font-bold rounded-xl hover:bg-white transition-all shadow-lg hover:shadow-xl hover:-translate-y-1 flex items-center justify-center gap-2"
                    >
                      {loading ? (
